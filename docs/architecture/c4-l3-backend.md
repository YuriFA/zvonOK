...
C4Component
    ...
    Container_Boundary(server, "NestJS Server") {
        ...
        Component(roomModule, "RoomModule", "NestJS Module", "Жизненный цикл комнат: создание, получение по slug, обновление, завершение. Фоновая очистка завершённых комнат. Делегирует завершение в SFUModule.")
    ...
    ContainerDb(postgres, "PostgreSQL", "PostgreSQL 16", "Пользователи и комнаты")
