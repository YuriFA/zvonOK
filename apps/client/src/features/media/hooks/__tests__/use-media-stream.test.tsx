...
import { MediaStreamProvider } from '../../contexts/media-stream.context';
...
describe('useMediaStream', () => {
  ...
  describe('initial state', () => {
    it('should not be loading initially', () => {
      const { result } = renderHook(() => useMediaStream(), { wrapper });
  ...
  describe('enabled option', () => {
    it('should auto-start when enabled is true', async () => {
      ...
      renderHook(() => useMediaStream({ enabled: true }), { wrapper });
    ...
    it('should not auto-start when enabled is false', () => {
      renderHook(() => useMediaStream({ enabled: false }), { wrapper });
    ...
    it('should stop stream on unmount', async () => {
      ...
      const { unmount } = renderHook(() => useMediaStream({ enabled: true }), { wrapper });
